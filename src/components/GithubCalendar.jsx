...
const GitHubCalendar = () => {
    ...
    return (
        <>
            ...
            <p className="card-text mt-2 mb-2 custom-text-secondary-2 d-none d-xl-block" style={{margin:0}}>These are my personal contributions, excluding company projects. This calendar is updated in real-time with the help of GitHub Developer APIs.</p>
